<%@ Page Title="" Language="C#" MasterPageFile="~/ShowShoppingCartMasterPage.master" AutoEventWireup="true" CodeFile="product_chushou.aspx.cs" Inherits="product_chushou" %>
...
<div>
    ...
    <li class="btn-switch-cart switch-cart-0 current"><a href="#" class="J_MakePoint" data-point="tbcart.8.35"><em>Selling Products</em></a></li>
    
    </ul>
    <div class="wrap-line"><div class="floater" style="width: 123px; left: -1px;"></div></div></div><div id="J_CartMain" class="cart-main"><div class="cart-table-th"><div class="wp"><div class="th th-chk"><div id="J_SelectAll1" class="select-all J_SelectAll"><div class="cart-checkbox"><input class="J_CheckBoxShop" id="J_SelectAllCbx1" type="checkbox" name="select-all" value="true"><label for="J_SelectAllCbx1"></label></div>Select All</div></div><div class="th th-item"><div class="td-inner">Product</div></div><div class="th th-info"><div class="td-inner">&nbsp;</div></div><div class="th th-price"><div class="td-inner">Price</div></div><div class="th th-amount"><div style=" margin-left:50px;" class="td-inner">Stock</div></div><div class="th th-sum"><div class="td-inner"></div></div><div class="th th-op"   style=" margin-left:110px;"><div class="td-inner">Operation</div></div></div></div>
        ...
        <ItemTemplate>
            ...
            &nbsp;&nbsp;Product ID：</b<a href="infodetail.aspx?productId=<%# Eval("ProductId")%>" target="_self" title='<%#Eval("ProductId") %>' class="J_MakePoint" ><strong><%#Eval("ProductId")%></strong></a></div></div><div class="order-content"><div id="J_BundleList_s_2182942593_1" class="item-list"><div id="J_Bundle_s_2182942593_1_0" class="bundle  bundle-last "><div id="J_ItemHolder_109138212368"><div id="J_Item_109138212368" class="J_ItemBody item-body clearfix item-normal  first-item  last-item   "> <ul class="item-content clearfix"> <li class="td td-chk"> <div class="td-inner"><div class="cart-checkbox "><input class="J_CheckBoxItem" id="J_CheckBox_109138212368" type="checkbox" name="items[]" value="109138212368"><label for="J_CheckBox_109138212368">勾选商品</label></div></div> </li> <li class="td td-item"> <div class="td-inner"> <div class="item-pic J_ItemPic img-loaded"><a href="infodetail.aspx?productid=<%# Eval("ProductId")%>" target="_self" title='<%# Eval("Name")%>' class="J_MakePoint" data-point="tbcart.8.12"><img src="showProductPicture.aspx?productid=<%# Eval("ProductId")%>" class="itempic J_ItemImg"></a></div>
             ...
             <li class="td td-amount">
              ...
              <div  style=" font-size:15px; font-weight:bold;color: #f40;" class="amount-wrapper ">
                  <asp:Label style=" padding-left:60px;"  ID="Stock" runat="server" Text='<%# Eval("Stock")%>'></asp:Label><br />
             ...
             <li class="td td-sum">
              ...
              <asp:LinkButton  title="Down Market" class="btn-fav J_Fav J_MakePoint" CommandName="downMarket"  ID="shCart" runat="server">Down Market</asp:LinkButton>
              <asp:LinkButton  title="修改" class="btn-fav J_Fav J_MakePoint"  ID="modifyProduct" runat="server">Edit</asp:LinkButton>
