...
public partial class User_Edit : basepage
{
    ...
    /*protected void edit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string sql = "update UserInfo set UserName='"+nickname+"',TrueName='"+truename+"',PhoneNum='"+phonenum+"',Address='"+addr+"' " +"where UserId='" + u.Userid.ToString() + "'";
            SqlCommand cmd = new SqlCommand(sql, cnn);
            cmd.ExecuteNonQuery();
            ...
            Response.Write("<script type='text/javascript' language='javascript'>function goToUrl(){window.location='User_Edit.aspx'}window.setInterval('goToUrl()',100);</script>");
        }
        catch (Exception ex)
        {
            Response.Write(ex.Message);
    ...
    {
        userPage.Attributes.Add("Src", "User_InfoEdit.aspx");
    }
    protected void userPasswordEdit_Click(object sender, EventArgs e)
    {
        userPage.Attributes.Add("Src", "User_NewPassWord.aspx");
    }
}