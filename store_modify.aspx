<%@ Page Title="" Language="C#" MasterPageFile="~/ShowShoppingCartMasterPage.master" AutoEventWireup="true" CodeFile="store_modify.aspx.cs" Inherits="store_modify" %>
...
<div class="main" style=" height:600px;"><!-- InstanceBeginEditable name="编辑区" -->
	<!--页面位置导航_start-->

        
        <div class="trationbj">
            <div class="tration">
                <h1 class="YaHei"> 商店修改</h1>
                <div class="fomeinput">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="fomeinput">
                        ...
                        <tr>
                            ...
                            <td width="69%" valign="middle">
                                 <div align="left">
                          <input onpropertychange="document.all.img1.src=this.value" type="file" name="uploadFile"  id="uploadFile" runat="server" />
                        </div>
                        <img height="100" runat="server" id="StoreLogo" src="images\showimg.gif" width="100" name="img1" />
                            </td>
                        </tr>
                        <tr>
                    <td>&nbsp;</td>
                    <td align="left">图片大小不超过200*200像素，仅支持JPG和JIF格式</td>      
                     ...
                     <tr valign="middle">
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Button ID="modify_Store"  class="btncss register_btn" runat="server" 
                                    Text="修改商店" onclick="modify_Store_Click"  />
                            </td>
                        </tr>
                    </tbody></table>
                </div>
