<%@ Page Title="" Language="C#" MasterPageFile="~/ShowShoppingCartMasterPage.master" AutoEventWireup="true" CodeFile="product_add.aspx.cs" Inherits="product_add" %>
            ...
            <div class="control-group">
                <div class="controls">
                    <asp:Button style=" background-color:Green;" ID="event_submit_do_publish"  class="btn btn-green btn-publish" 
                        runat="server" Text="Add" onclick="event_submit_do_publish_Click" />
                </div>
            </div>
        </div>
        </div>
